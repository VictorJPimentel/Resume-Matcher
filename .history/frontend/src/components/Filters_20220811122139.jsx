...
function Filter() {
  ...
  return (
    <div
      className="flex flex-col justify-center items-centerz-40 left-0 top-0 h-full no-scrollbar w-2/5 border-r border-slate-200 
      text-center"
    >
      Filters
      <div class="flex border-b bg-white-100">
        <div class="p-6 ">
