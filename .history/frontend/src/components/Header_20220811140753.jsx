...
function Header() {
  return (
    <header className="top-0 bg-white border-b border-slate-200 z-30 w-full h-16">
      <nav class="font-sans flex flex-col text-center content-center sm:flex-row sm:text-left sm:justify-between border-slate-200 py-2 px-6 bg-white sm:items-baseline w-full">
        <div
